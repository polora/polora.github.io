...
* reprendre la fenêtre de jeu créée dans l’exercice précédent.
* écrire le code qui permet de déplacer la raquette de droite à gauche.  
__Attention :__ la raquette ne doit pas dépasser les murs de droite et gauche (revoir dans le cours comment nous avons fait pour le vaisseau).
