...
ETAPE 6
Déplacement du personnage avec les touches du clavier (image choisie : seulement la première isolée
d'une feuille de sprites)
Inversion de l'image quand changement de direction
Gestion de la collision avec les bords d'écran
