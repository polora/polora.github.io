...
"""
ETAPE 9
    - dans cette version, on charge tous les sprites de la feuille
    - la succession des sprites permet d'obtenir une animation de notre personnage

Quelques modifications ont été apportées dans la méthode animate (pour ralentir un peu
...
FPS = 30
# feuille de sprites
SPRITESHEET = 'assets/player2.png'
...
class Player(pygame.sprite.Sprite):
    ...
    def animate(self, direction):
        ...
        # comme on incrémente la position de 0.2, on pense à caster self.current_image 
        # en entier
