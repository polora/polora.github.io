...
TODO :
    ...
    - musique de fond : nouvelle à trouver
...
class Ship(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        # sounds
        self.laser_ship = pygame.mixer.Sound('./assets/laser_ship.wav')
...
class Alien(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y,image):
        ...
        self.direction = 0
        self.laser_alien = pygame.mixer.Sound('./assets/laser_alien.wav')
...
class Game():
    ...
    def __init__(self):
        ...
        pygame.mixer.music.load('./assets/arpanauts.ogg')
        pygame.mixer.music.play(-1)
        pygame.mixer.music.set_volume(0.5)
        
        # fonts
        self.tinyFont = pygame.font.Font("./assets/Gameplay.ttf",20)
        self.bigFont = pygame.font.Font("./assets/Gameplay.ttf",40)
    ...
    def create_Aliens(self,x,y):
        ...
        # images
        self.alien1_image = pygame.image.load("./assets/alien1.png").convert_alpha()
        self.alien2_image = pygame.image.load("./assets/alien2.png").convert_alpha()
        self.alien3_image = pygame.image.load("./assets/alien3.png").convert_alpha()
        
        # sounds
        self.explosion_alien = pygame.mixer.Sound('./assets/explosion_alien.wav')
        self.explosion_ship = pygame.mixer.Sound('./assets/explosion_ship.wav')
